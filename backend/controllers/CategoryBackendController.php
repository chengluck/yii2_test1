...
use backend\models\CategoryBackendSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * CategoryBackendController implements the CRUD actions for CategoryModel model.
 */
class CategoryBackendController extends Controller
{
    ...
    {
        $searchModel = new CategoryBackendSearch();
